...
from kernels.graphlet_kernel import (
    run_graphlet_kernel,
)
...
def main():
    ...
    output_file = os.path.join(
        output_dir,
        "graphlet_collegemsg_results.csv"
    )
